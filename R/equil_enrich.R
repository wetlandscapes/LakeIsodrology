...
#' (\eqn{‰}), given a known liquid-vapor equilibrium fractionation.
#'
...
#'
#' @param a_VL Liquid-vapor equilibrium fractionation factor, \eqn{\alpha_{V/L}} [\eqn{-}].
#'
#' @export
#'
#' @examples
#'
equil_enrich <- function(a_VL){
  e_VL <- (1 - a_VL) * 1e3
  e_VL
}
